...
import { DEFAULT_PAYEMENT_METHOD, PAYEMENT_METHODS } from "@/lib/constants";
...
const PaymentMethodForm = ({ 
    ...
    const form = useForm<z.infer<typeof paymentMethodSchema>>({
        ...
        defaultValues: {
            type: preferredPaymentMethod || DEFAULT_PAYEMENT_METHOD,
        },
    });
    ...
    return ( 
        <>
            <div className="max-w-md mx-auto space-y-4">
                ...
                <p className="text-small text-muted-foreground">Please select a payment method</p>
                <Form {...form}>
                                    ...
                                    <FormItem className="space-y-3">
                                        <FormControl>
                                            <RadioGroup onValueChange={field.onChange} className="flex flex-col space-y-2">
                                                {PAYEMENT_METHODS.map((paymentMethod) => (
